(function () {
  ...
  const ContaDigitalCadastro = {
          ...
          <form class="cb-form" id="cadastro-form">
            ...
            <div class="cb-form-group">
              ...
              <div class="cb-input-group">
                ...
                <button type="button" id="cadastro-toggle-senha" class="cb-input-toggle" aria-label="Mostrar senha" title="Mostrar senha">
            ...
            <div class="cb-form-group">
              ...
              <div class="cb-input-group">
                ...
                <button type="button" id="cadastro-toggle-confirmacao" class="cb-input-toggle" aria-label="Mostrar senha" title="Mostrar senha">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                </button>
              </div>
            </div>
    ...
    bindEvents() {
      ...
      bindPasswordToggle('cadastro-toggle-senha', 'cadastro-senha', 'Mostrar senha', 'Ocultar senha');
      bindPasswordToggle('cadastro-toggle-confirmacao', 'cadastro-confirmacao', 'Mostrar confirmação de senha', 'Ocultar confirmação de senha');
